  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="userAddress.id"
        @click="changeSelected(userAddress.id)"
      >
        <span :class="{ username: true, selected: userAddress.isSelect }">{{
          userAddress.name
        }}</span>
        <p>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ seletUser.address }}</span>
        收货人：<span>{{ seletUser.name }}</span>
        <span>{{ seletUser.phone }}</span>
      </div>
    </div>
...
export default {
  ...
  async mounted() {
    ...
    console.log(res);
    this.orderList = res.detailArrayList;
    this.totalAmount = res.originalTotalAmount;
