  ...
  <div class="pay-main">
    <div class="pay-container">
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money">￥{{ $route.query.orderPrice }}</em></span
          >
        </div>
      </div>
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <button class="btn" @click="paySuccess">立即支付</button>
        </div>
        <div class="otherpay">
          <div class="step-tit">
            <h5>其他支付方式</h5>
          ...
          <Dialog title="xxx" width="30%" :visible.sync="visible">
            ...
            <template #footer>
              <div class="slot-footer">
                <button class="dialogBtn">支付遇到问题</button>
                <button class="dialogBtn-success">支付成功</button>
              </div>
            </template>
          </Dialog>
        </div>
...
import { reqQueryPayStatus, reqQrcode } from "../../api/pay";
...
export default {
  ...
  methods: {
    async paySuccess() {
      this.visible = true;
      const { codeUrl } = await reqQrcode(this.$route.query.orderId);
